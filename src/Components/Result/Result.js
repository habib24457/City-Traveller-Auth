            ...
            <Container>
                    ...
                    <div className="col-md-4 ">
                        <Form className="search-design">
                            <input onBlur={handleBlur} className="form-control" type="text"
                                placeholder="Pick from" name="locationFrom" id="fromLoc" required />
                            <br />
                            <input onBlur={handleBlur} className="form-control" type="text"
                    ...
                    <div className="col-md-4 show-map">
                        <Form className="search-design">
                            <Form.Group>
                                ...
                                <Form.Control id="youngTicketAmount" value={youngTicket} type="Text" required readOnly />
                                <h3 style={{ cursor: 'pointer' }}><span name="youngMinus" onClick={handleYoungTicket}>-</span> <span name="youngPlus" onClick={handleYoungTicket} >+</span></h3>
                            </Form.Group>

                            <Form.Group>
                                <Form.Label>Ticket for adult = 150$</Form.Label>
                                <Form.Control id="adultTicketAmount" value={adultTicket} type="Text" required readOnly />
                                <h3 style={{ cursor: 'pointer' }}><span name="adultMinus" onClick={handleYoungTicket}>-</span> <span name="adultPlus" onClick={handleYoungTicket}>+</span></h3>
                            </Form.Group>
                        </Form>
                    </div>
                ...
                <div className="row">
                    <div className="col-md-12 text-center mt-3">
                        <h3>Google map isn't showing because I didn't purchase google map API</h3>
                        <br />
                        <Map></Map>
                    </div>
                </div>
